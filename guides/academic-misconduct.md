...
misconduct, divided into two categories: Point Penalties and Office of Student
Conduct Referrals.
...
The Office of Student Conduct will issue a formal warning to you that
...
outside the OSC, or as they put it "records of non-reportable warnings are
...
- **Option 1**: You accept that you allowed another student to have a copy of
  ...
  form. You will receive a point penalty and will be referred to the Office of
  ...
  instructors, though this will not prevent an OSC warning. This penalty
...
- **Option 2**: You accept that you submitted work that was not your own for a
  ...
  Office of Student Conduct for an NRW. Optionally, you may meet with the
  instructors, though this will not prevent an OSC warning.
...
- **R3**: We determine that you have overcollaborated in a way that violates the course policy, but is not egregious, or that you have given someone else your code. Copying any part of another student’s code is considered egregious. You will receive a point penalty, and you will receive an NRW from the OSC.
- **R4**: We determine that you have committed an egregious violation of the course policies, e.g. submitting work that is not your own. You will receive a more severe point penalty on that assignment, and you will receive an NRW from the OSC.

### Phase 3: External Adjudication

If we are unable to come to an agreement in Phase 2, we will refer your case to
the Office of Student Conduct. They will conduct their own investigation, and
resolve your case through their own process.

Note that sanctions are likely to be more severe if the OSC determines you
