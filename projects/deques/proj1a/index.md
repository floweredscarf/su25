...
>the Linked List lecture, Lecture 4.
...
[Assignment Workflow guide](../../../guides/assignment-workflow.md)
...
>**and including** the Linked List lecture, Lecture 4.
...
(Also, we have just under 360 students! No way we're doing that to grade
everyone's work.)
...
You should write your tests in `LinkedListDeque61BTest.java`. The tests in this file will be run on a staff-written buggy implementation of a `LinkedListDeque61B` to determine your test coverage.
