...
We encourage everyone to treat the project as if it is officially due **Friday, June 21st, 11:59pm**. We host office hours, project parties, and answer questions on Edstem Monday through Friday.
...
[lateness policy]: ../../about.md#late-policy
...
- [61B Style Guide](../../guides/style-guide.md) (we are checking your style in autograder!)
...
Follow the instructions in the [Assignment Workflow Guide](../../guides/assignment-workflow.md) to get the skeleton code and open it in IntelliJ. For this project, we will be working in the `proj0/` directory.
...
Starting with this project, **we will be enforcing style**. You must follow the [style guide](../../guides/style-guide.md), or you will be penalized on the autograder.
