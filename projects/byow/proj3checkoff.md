...
skeleton's library-su24 folder. If your code uses additional libraries, then the TA will not be able to compile nor run
...
1. The grader will ask for everyone's class ID (su24-s\*\*\*)
