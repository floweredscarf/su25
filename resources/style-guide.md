...
2. Do not use nested assignments, such as "if ((x = next()) != null) ...".
   Although this can be useful in C, it is almost never necessary in Java.

3. Include a "default" case in every "switch" statement.

4. End every arm of a "switch" statement either with a "break" statement
...
5. Do not compare String literals with "==". Write
